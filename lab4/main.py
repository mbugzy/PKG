...
class MyApp:
    def __init__(self):
        ...
        self.style.configure("TFrame", background="#0000ff", foreground="white")
        ...
        x1_label = ttk.Label(self.menu_bar, text="x1 (x0)", background="#0000ff")
        x1_label.pack(side="top")

        x1_input = ttk.Entry(self.menu_bar, validate="all",
                             validatecommand=(self.menu_bar.register(self.check_number), "%P"))
        x1_input.pack(fill="x", pady=2, side="top")

        y1_label = ttk.Label(self.menu_bar, text="y1 (y0)", background="#0000ff")
        y1_label.pack(side="top")

        y1_input = ttk.Entry(self.menu_bar, validate="all",
                             validatecommand=(self.menu_bar.register(self.check_number), "%P"))
        y1_input.pack(fill="x", pady=2, side="top")

        x2_label = ttk.Label(self.menu_bar, text="x2 (R)", background="#0000ff")
        x2_label.pack(side="top")

        x2_input = ttk.Entry(self.menu_bar, validate="all",
                             validatecommand=(self.menu_bar.register(self.check_number), "%P"))
        x2_input.pack(fill="x", pady=2, side="top")

        y2_label = ttk.Label(self.menu_bar, text="y2", background="#0000ff")
        y2_label.pack(side="top")

        y2_input = ttk.Entry(self.menu_bar, validate="all",
                             validatecommand=(self.menu_bar.register(self.check_number), "%P"))
        ...
        button_step = Button(self.menu_bar, text="Пошаговый алгоритм", command=self.build_step, background="#ffff00")
        button_step.pack(fill="x", pady=2, side="top")

        button_dda = Button(self.menu_bar, text="Алгоритм DDA", command=self.build_dda, background="#ffff00")
        button_dda.pack(fill="x", pady=2, side="top")

        button_bres = Button(self.menu_bar, text="Алгоритм Брезенхема", command=self.build_bres, background="#ffff00")
        button_bres.pack(fill="x", pady=2, side="top")

        button_bres_circle = Button(self.menu_bar, text="Алгоритм Брезенхема(окружность)", command=self.build_circle,
                                    background="#ffff00")
        button_bres_circle.pack(fill="x", pady=2, side="top")

        button_castle_pitway = Button(self.menu_bar, text="Алгоритм Кастла-Питвея", command=self.build_castle_pitway,
                                      background="#ffff00")
        ...
        scale_label = ttk.Label(self.menu_bar, text="Scale", background="#0000ff")
        ...
        time_label = ttk.Label(self.menu_bar, text="Time:", background="#0000ff")
